...
void Tokenizer::parseToken()
{
  ...
  istr.close();
  //cout<<"count value inside skipToken "<<count<<endl;
...
************************************************************************************/
  ...
  //tokenDone=1;
  //cout<<"count at end of skipToken "<<count<<endl;
}

void Tokenizer::skipToken()
{
  index++;
  //cout<<"index-skipToken "<<index<<endl;
...
int Tokenizer::getToken()
{
	...
	//cout<<"index getToken "<<index<<endl;
  	//cout<<"count in getToken "<<count<<endl;
	//cout<<"lines of index 0 "<<lines[0]<<endl;
	...
	if(flag_Num==1) {return 31;good=1;}
	...
	if(flag_Upper==1) {return 32;good=1;}

	if((index==count) && (lines[index-3] == "end"))
	{
		return -2; good=1;
	}
	else if(index==count) {
	...
	//else if(lines[index-3] == "end") { return -1; good=1; }
