...
private:
  ...
  size_t found;
  static const int k=0,n=0,count=0,count1=0,m=0;
  static const int flag_Plus=0, flag_Equal=0, flag_LeftParentheses=0, flag_Semicolon=0, flag_Num=0, flag_Upper=0, flag_Alnum=0, flag_RightParentheses=0, flag_Comma=0, flag_Variable=0;
